...
launch_list = [
   {"model": all_models.PoseCNNsc_13_24_35_stage1, "config": config1, "classes_to_exclude": classes_to_exclude_1},
   {"model": all_models.PoseCNNsc_13_24_35_final2, "config": config_final_2, "classes_to_exclude": classes_to_exclude_2}
]
