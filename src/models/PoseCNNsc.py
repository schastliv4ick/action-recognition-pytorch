...
class PoseCNNsc(nn.Module):
    ...
    def forward(self, x):
        ...
        # Skip connection 2 -> 4
        skip2 = self.skip2_proj(x2)  # (256, H/16, W/16)
        x4 = x4 + skip2
...
if __name__ == '__main__':
    model = PoseCNNsc(num_classes=10)
    input_tensor = torch.randn(1, 3, 288, 512)
